                    ...
                    <div className="md:py-8">
                        ...
                        <div className="mb-4">
                            <div className="flex items-end gap-2">
                                <span className="text-xl font-bold text-gray800 md:text-2xl">${data.price}</span>
                                <span className="mb-0.5 text-red-500 line-through">${data.price + 30000}</span>
                            </div>
                        ...
                        <div className="flex gap-2.5">
                            <AddToBag currency="USD" description={data.description}name={data.name}
                            image={data.images[0]}
                            price={data.price}
                            key={data._id}
